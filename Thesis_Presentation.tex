...
\begin{frame}
    \begin{itemize}
        \item[$\bullet$] Cuja solução é única e dada por $y_2(t) = \frac{1}{2}(x^2 - 4x + 3)$
    ...
    \small
        ...
        \begin{itemize}
            \item[$\bullet$] $y'$ tem uma descontinuidade no 0 já que
                ...
                mas $y'$ é contínua para todo $t > 0$.


            \item[$\bullet$] $y''(t)$ tem uma descontinuidade no 1 já que 
...
\begin{frame}{SIR com retardo?}
    ...
    Colocar a foto dos compartimentos 

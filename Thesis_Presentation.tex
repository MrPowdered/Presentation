...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{frame}
        ...
        \small
        \begin{definition}[Ordem Local de um método discreto]
...
\begin{frame}{Ordem Local do Interpolante}
    ...
    \small
    \begin{definition}[Ordem Local do interpolante]
...
\begin{frame}{Apêndice}
    \begin{definition}[Norma induzida de matrizes]
...
\begin{frame}{Apêndice}
    ...
    \small
    \begin{definition}[Produto de Kronecker]
